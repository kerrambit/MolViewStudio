...
def main():
    ...
    parser.add_argument('--port', type=int, default=41050,
                    help='Port to bind to (default: 41050)')
    parser.add_argument('--env', type=str, default="dev",
                    help='Run server in given mode: development or production')
    parser.add_argument('--cors', nargs='*', default=[],
    ...
    print(f">>> Starting Mol* App Server on <{args.host}:{args.port}> with log level set to <info>.")
    print(f">>> Other settings: environment: <{settings.env}>, CORS: <{settings.cors}>, reloading: {reload}.")
